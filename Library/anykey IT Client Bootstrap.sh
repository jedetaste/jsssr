...
if [[ "$(sw_vers -buildVersion)" > "16" ]]; then
  ...
  defaults write /private/var/db/timed/Library/Preferences/com.apple.timed TMAutomaticTimeZoneEnabled -bool true
  defaults write /private/var/db/timed/Library/Preferences/com.apple.timed TMAutomaticTimeOnlyEnabled -bool true
