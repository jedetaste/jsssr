#!/bin/bash
  ...
  /usr/local/bin/aky --remove millefeuilles
  
  # Install Millefeuilles.app
  
  /usr/local/bin/aky --patch "https://github.com/jedetaste/aky-static/raw/master/millefeuilles.json"
